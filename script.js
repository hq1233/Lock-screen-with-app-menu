...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            "Hi i'm Harsh, Toh Kaise hai aaplog? ",
...
const Tools = () => {
    const getTools = () => {
        return [{
                ...
                id: 1,
                image: "https://www.pngkey.com/png/detail/87-873887_call-phone-icon-gray-png.png",
                label: "Call",
                ...
                id: 3,
                image: "https://i.pinimg.com/736x/43/ad/52/43ad5244d4e5ea3bedc1c7c9e0089fba.jpg",
                label: "Whatsapp",
                ...
                id: 5,
                image: "https://www.clipartmax.com/png/middle/335-3351531_chess-game-sport-grey-icon-black-icon-grey-board-game-piece-icon.png",
                label: "Games",
...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "It's Dosa'o clock!",
                id: 1,
                image: "https://images.pexels.com/photos/5560763/pexels-photo-5560763.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
                title: "Dosa"
            }, {
                desc: "Eat it before it melts",
                id: 2,
                image: "https://images.pexels.com/photos/2846337/pexels-photo-2846337.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
                title: "Ice Cream"
            }, {
                desc: "Do good. Be nice. Order pizza. Repeat",
                id: 3,
                image: "https://images.pexels.com/photos/315755/pexels-photo-315755.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
                title: "Pizza"
            }, {
                desc: "Biryani- forever and always",
                id: 4,
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "Are u feeling hungry? Order Now!!" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                ...
                id: 1,
                image: "https://wallpapercave.com/wp/wp4922409.jpg",
                title: "Harry Potter"
            }, {
                
                id: 2,
                image: "https://m.media-amazon.com/images/I/71TZ8BmoZqL.jpg",
                title: "Lord of the Rings"
            }, {
                
                id: 3,
                image: "https://c4.wallpaperflare.com/wallpaper/348/807/756/tv-show-stranger-things-caleb-mclaughlin-eleven-stranger-things-finn-wolfhard-hd-wallpaper-preview.jpg",
                title: "Stranger Things"
            }, {

                id: 4,
                image: "https://mumu-global.fp.ps.easebar.com/file/6266792c9e15b77b9b0d04f0X0eP37JW02",
                title: "Squid-Games"
            }].map((movie) => {
            const styles = {
